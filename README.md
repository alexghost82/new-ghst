...
- **AI**: OpenAI API (chat: gpt-4o, embeddings: text-embedding-3-small). Optional [local VLM](./docs/local-vlm.md) for on-prem or GPU-hosted vision ([cloud deploy](./docs/cloud-deployment.md)).
...
- Cloud production layout (Firebase Hosting → `ghst-api` → `ghost-vlm` GPU): [docs/cloud-deployment.md](./docs/cloud-deployment.md)
